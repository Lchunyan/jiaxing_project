...
namespace Ximmerse.XR.InputSystems
{
    ...
    public static class InputLayout
    {
        ...
        public static void RegisterInputLayouts()
        {
            ...
            InputSystem.RegisterLayout<XRController>(matches: new InputDeviceMatcher().WithInterface(XRUtilities.InterfaceMatchAnyVersion).WithProduct(@"^(LeftHand)|^(RightHand)"));
        }
    }
}